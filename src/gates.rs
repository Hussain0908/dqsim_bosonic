...
#[inline] pub const fn c(re: f64, im: f64) -> C { C::new(re, im) }
#[inline] pub const fn r(re: f64)           -> C { C::new(re, 0.0) }

// ---------------------------------------------------------------------------
// Fixed single-qubit gates
// ---------------------------------------------------------------------------

pub const X: Mat2 = [[r(0.0), r(1.0)],
                     [r(1.0), r(0.0)]];

pub const Y: Mat2 = [[r(0.0), c(0.0, -1.0)],
                     [c(0.0,  1.0), r(0.0)]];

pub const Z: Mat2 = [[r(1.0), r(0.0)],
                     [r(0.0), r(-1.0)]];
...
pub fn s_gate() -> Mat2   { [[r(1.0), r(0.0)], [r(0.0), c(0.0, 1.0)]] }
pub fn sdg() -> Mat2      { [[r(1.0), r(0.0)], [r(0.0), c(0.0, -1.0)]] }
pub fn t_gate() -> Mat2 {
...
pub fn u2(phi: f64, lam: f64) -> Mat2 { u3(PI / 2.0, phi, lam) }
pub fn u1(lam: f64) -> Mat2           { [[r(1.0), r(0.0)], [r(0.0), c(lam.cos(), lam.sin())]] }
pub fn u(theta: f64, phi: f64, lam: f64) -> Mat2 { u3(theta, phi, lam) }
pub fn p(lam: f64) -> Mat2            { u1(lam) }
...
pub fn cy() -> Mat4 {
    let o = r(0.0); let i = r(1.0);
    [[i,o,o,o],[o,i,o,o],[o,o,o,c(0.0,-1.0)],[o,o,c(0.0,1.0),o]]
}
pub fn ch() -> Mat4 {
    let s = FRAC_1_SQRT_2;
    let o = r(0.0); let i = r(1.0);
    [[i,o,o,o],[o,i,o,o],[o,o,r(s),r(s)],[o,o,r(s),r(-s)]]
}
pub fn swap() -> Mat4 {
    let o = r(0.0); let i = r(1.0);
...
pub fn csx() -> Mat4 {
    let o = r(0.0); let i = r(1.0);
    let a = c(0.5, 0.5); let b = c(0.5, -0.5);
...
pub fn crx(theta: f64) -> Mat4 { controlled(rx(theta)) }
pub fn cry(theta: f64) -> Mat4 { controlled(ry(theta)) }
pub fn crz(lam: f64)   -> Mat4 { controlled(rz(lam)) }
pub fn cu1(lam: f64)   -> Mat4 { controlled(u1(lam)) }
pub fn cp(lam: f64)    -> Mat4 { controlled(p(lam)) }
pub fn cu3(theta: f64, phi: f64, lam: f64) -> Mat4 { controlled(u3(theta, phi, lam)) }
pub fn cu(theta: f64, phi: f64, lam: f64, gamma: f64) -> Mat4 {
    let phase = c(gamma.cos(), gamma.sin());
    let inner = u3(theta, phi, lam);
    let phased = [[phase * inner[0][0], phase * inner[0][1]],
...
pub fn ccx() -> Mat8 {
    let mut m = identity8();
    m[6][6] = r(0.0); m[7][7] = r(0.0);
    m[6][7] = r(1.0); m[7][6] = r(1.0);
    m
}
pub fn cswap() -> Mat8 {
    let mut m = identity8();
    m[5][5] = r(0.0); m[6][6] = r(0.0);
    m[5][6] = r(1.0); m[6][5] = r(1.0);
    m
}
pub fn rccx() -> Mat8 {
    let mut m = identity8();
    m[6][6] = r(0.0); m[7][7] = r(0.0);
    m[6][7] = c(0.0, 1.0); m[7][6] = c(0.0, -1.0);
    m
}
...
pub fn rc3x() -> Mat16 {
    ...
    m[14][14] = c(0.0, 1.0); m[14][15] = r(0.0);
    m[15][14] = r(0.0);      m[15][15] = c(0.0, -1.0);
    m
}
pub fn c3x() -> Mat16 {
    let mut m = identity16();
    m[14][14] = r(0.0); m[15][15] = r(0.0);
    m[14][15] = r(1.0); m[15][14] = r(1.0);
    m
}
pub fn c3sqrtx() -> Mat16 {
    let mut m = identity16();
    let sx = sx();
    m[14][14] = sx[0][0]; m[14][15] = sx[0][1];
    m[15][14] = sx[1][0]; m[15][15] = sx[1][1];
    m
}
...
pub fn c4x() -> Mat32 {
    ...
    m[30][30] = r(0.0); m[31][31] = r(0.0);
    m[30][31] = r(1.0); m[31][30] = r(1.0);
    m
}
